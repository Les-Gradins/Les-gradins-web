 ...
 export let Tracklist: Chanson[] = [

        {
            ...
            bdPath: '/assets/LES GRADINS_BD_WEB/1-LES_GRADINS(XII)/1-LES_GRADINS(XII)_',
            url: '/assets/audio/Non-ACC/01_Les_gradins.m4a',
            casenumber: 9,
            rotDeg: 376
        },

        {
            ...
            bdPath: '/assets/LES GRADINS_BD_WEB/2-REPEAT/2-REPEAT_',
            url: '/assets/audio/Non-ACC/02_Repeat.m4a',
            casenumber: 18,
            rotDeg: 48
        },

        {
            ...
            bdPath: '/assets/LES GRADINS_BD_WEB/3-MOIMAN/3-MOIMAN_',
            url: '/assets/audio/Non-ACC/03_Moiman.m4a',
            casenumber: 18,
            rotDeg: 71
        },

        {
            ...
            bdPath: '/assets/LES GRADINS_BD_WEB/4-SUNSHINE(III)/4-SUNSHINE(III)_',
            casenumber: 18,
            url: '/assets/audio/Non-ACC/04_Sunshine.m4a',
            rotDeg: 98
        },

        {
            ...
            casenumber: 18,
            url: '/assets/audio/Non-ACC/05_Carre_saint_louis.m4a',
            rotDeg: 141
        },

        {
            ...
            casenumber: 9,
            url: '/assets/audio/Non-ACC/06_Vrai.m4a',
            rotDeg: 172
        },
...

        {
            ...
            casenumber: 9,
            url: '/assets/audio/Non-ACC/08_Immortel.m4a',
            rotDeg: 226
        },

        {
            ...
            casenumber: 18,
            url: '/assets/audio/Non-ACC/09_Lequipe.m4a',
            rotDeg: 251
        },

        {
            ...
            casenumber: 9,
            url: '/assets/audio/Non-ACC/10_Carnaval.m4a',
            rotDeg: 280
        },

        {
            ...
            casenumber: 9,
            url: '/assets/audio/Non-ACC/11_Dans_le_vent.m4a',
            rotDeg: 317
        },

        {
            ...
            casenumber: 9,
            url: '/assets/audio/Non-ACC/12_Olympe.m4a',
            rotDeg: 345
        }
